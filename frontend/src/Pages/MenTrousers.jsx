...
export default function Trousers() {
  ...
  useEffect(() => {
    axios.get("http://localhost:8080/api/men?sub=Trousers")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${menImage})`, backgroundPosition: "center", backgroundSize: "cover" }}>
        ...
        <h1 className="men__hero-title">Trousers</h1>
        <p className="men__hero-desc">Smart trousers for every occasion</p>
      </div>
