...
export default function Shirts() {
  ...
  useEffect(() => {
    axios.get("http://localhost:8080/api/men?sub=Shirts")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${menImage})`, backgroundPosition: "center", backgroundSize: "cover" }}>
        ...
        <h1 className="men__hero-title">Shirts</h1>
        <p className="men__hero-desc">Classic and modern shirts for every occasion</p>
      </div>
            ...
            return (
              <div key={item.id} className="men__card">
                <div className="men__card__img-wrap">
                  {/* ✅ FIXED: use imageUrl from database */}
                  <img
