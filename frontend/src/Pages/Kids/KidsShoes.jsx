...
import kidsImage from "../../Images/home2.jpg";
...
export default function KidsShoes() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/kids?sub=Shoes")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${kidsImage})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <h1 className="men__hero-title">Kids Shoes</h1>
        <p className="men__hero-desc">Stylish shoes for little feet</p>
      </div>
