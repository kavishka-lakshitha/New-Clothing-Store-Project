...
import kidsImage from "../../Images/home1.jpg";
...
export default function KidsShorts() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/kids?sub=Shorts")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${kidsImage})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <h1 className="men__hero-title">Kids Shorts</h1>
        <p className="men__hero-desc">Fun shorts for active kids</p>
      </div>
