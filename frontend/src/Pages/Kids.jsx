...
const CATEGORIES = ["All", "T-Shirts", "Shorts", "Shoes"];
...
export default function Kids() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/kids")
  ...
  return (
    <div className="men">
      ...
      >
        ...
        <h1 className="men__hero-title">Kids</h1>
        <p className="men__hero-desc">Fun & comfy styles for little ones</p>
      </div>
              ...
              return (
                <div key={item.id} className="men__card">
                  ...
                  <div className="men__card__colors">
                    {colors.map((color, i) => (
                      <span key={i} className="men__card__color" style={{ background: color }} title={color} />
                    ))}
                  </div>
