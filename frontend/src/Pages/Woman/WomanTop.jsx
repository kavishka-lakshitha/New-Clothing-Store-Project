...
export default function WomanTops() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/women?sub=Tops")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${womenImage})`, backgroundPosition: "center", backgroundSize: "cover" }}>
        ...
        <h1 className="men__hero-title">Women Tops</h1>
        <p className="men__hero-desc">Trendy & stylish tops</p>
      </div>
