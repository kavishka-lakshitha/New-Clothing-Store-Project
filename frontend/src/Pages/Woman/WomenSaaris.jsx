...
import womenImage from "../../Images/home4.jpg";
import { useCart } from "../../context/CartContext";

export default function WomanSaaris() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/women?sub=Saaris")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${womenImage})`, backgroundPosition: "center", backgroundSize: "cover" }}>
        ...
        <h1 className="men__hero-title">Women Saaris</h1>
        <p className="men__hero-desc">Timeless saaris for every occasion</p>
      </div>
