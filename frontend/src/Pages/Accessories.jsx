...
import accessoriesImage from "../Images/accesseries.jpg";
import { useCart } from "../context/CartContext";


const CATEGORIES = ["All", "Bags", "Belts", "Sunglasses", "Watches"];
...
export default function Accessories() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/accessories")
  ...
  return (
    <div className="men">
      ...
      >
        ...
        <h1 className="men__hero-title">Accessories</h1>
        <p className="men__hero-desc">Complete your look with our curated accessories</p>
      </div>
