...
import "./Men.css";
import menImage from "../Images/home2.jpg";
...
export default function TShirts() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/men?sub=T-Shirts")
      .then((res) => {
  ...
  return (
    <div className="men">
      ...
      >
        ...
        <h1 className="men__hero-title">T-Shirts</h1>
        <p className="men__hero-desc">Premium T-Shirts for the modern man</p>
      </div>
