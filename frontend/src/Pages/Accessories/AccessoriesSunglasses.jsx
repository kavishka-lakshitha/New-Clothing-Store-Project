...
import accessoriesImage from "../../Images/home4.jpg";

export default function AccessoriesSunglasses() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/accessories?sub=Sunglasses")
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${accessoriesImage})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <h1 className="men__hero-title">Sunglasses</h1>
        <p className="men__hero-desc">Shade your style with our collection</p>
      </div>
