...
import "./Men.css";
import menImage from "../Images/home3.jpg";

export default function MenBlazers() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/men?sub=Blazers")
      .then((res) => {
  ...
  return (
    <div className="men">
      <div className="men__hero" style={{ backgroundImage: `url(${menImage})`, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
        <p className="men__hero-label">Amandi Fashion</p>
        <h1 className="men__hero-title">Blazers</h1>
        <p className="men__hero-desc">Sharp blazers for the distinguished gentleman</p>
      </div>
